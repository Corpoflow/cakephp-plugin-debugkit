...
(function() {
    ...
    // Detect jquery
    if (!window.$) {
        console.log('No jQuery detected, please load jQuery to enable the DebugKit');
        return;
    }
    ...
    DEBUGKIT.toolbarToggle = function() {
        ...
        return {
            ...
            toggleToolbar: function() {
                var display = toolbarVisible ? 'show' : 'hide';

                Cookie.write('toolbarDisplay', display);
                toolbarVisible = !toolbarVisible;

                if (toolbarVisible) {
                    $('#debug-kit-toolbar').addClass('visible');
                } else {
                    $('#debug-kit-toolbar').removeClass('visible');
                }
